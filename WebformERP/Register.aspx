<%@ Page Title="" Language="C#" MasterPageFile="~/Employee.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="WebformERP.Register" %>
    ...
    <script>
        ...
        let emailcon = /^([a-zA-Z0-9_\.\-])+\@(([a-zA-Z0-9\-])+\.)+([com\co\.\in])+$/;
            ...
            if (name == "" || email == "" || phone == "" || dept == "Select") {
                swal("Please fill all details to proceed..!","","success");
                return false;
            }
            if (phone != '') {
